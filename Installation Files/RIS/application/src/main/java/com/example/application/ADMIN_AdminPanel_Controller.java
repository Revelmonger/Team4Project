...
public class ADMIN_AdminPanel_Controller extends EncryptDecrypt implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
                ...
                CreateNewModalityButton.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent e) {
                        ...
                        if (PatientAlertNameField.getText().isEmpty()) {
                            ...
                            try {
                                String InsertIntoAlerts = "insert into alerts (alert_name) values ('"
                                        + PatientAlertNameField.getText().trim() + " ');";
                ...
                CreateNewModalityButton.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent e) {
                        ...
                        if (ModalityNameTextField.getText().isEmpty() || ModalityPriceTextField.getText().isEmpty()) {
                            ...
                            try {
                                String InstertIntoModalitiesTable = "insert into modalities (name, price) values ('"
                                        + ModalityNameTextField.getText().trim() + "', '"
                                        + ModalityPriceTextField.getText().trim() + "')";
                                Statement statement = connectDB.createStatement();
                ...
                SaveUserButton.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent e) {
                        ...
                        if (phoneNumberField.getText().isEmpty() || emailAddressField.getText().isEmpty()
                                ...
                                || SelectedAppointmentTime.getValue().isEmpty() || OrdersChoiceBox.getValue().isEmpty()
                            ...
                            try {
                                ...
                                while (queryOutput.next() && queryOutput2.next()) {
                                    ...
                                    String InsertIntoUsersTableQuery = "insert into appointments (patient, order_id, modality, date_time, radiologist, phone_number, email_address) values ('"
                                            + patientID + "', '" + OrdersChoiceBox.getValue() + "', '" + modality
                                    ...
                                    while (queryOutput3.next()) {
                                        ...
                                        String InsertAppointmentID = "update orders set appointment = '" + appointmentID
                                                + "' where order_id = '" + OrdersChoiceBox.getValue() + "';";
            ...
            public void handle(ActionEvent event) {
                ...
                CreateDiagnosticReportButton.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent e) {
                        ...
                        if (RadiologistChoiceBox.getValue().isEmpty() || OrdersChoiceBox.getValue().isEmpty()
                            ...
                            try {
                                ...
                                String RadiologistQuery = "Select id from radiologists where full_name = '"
                                        + RadiologistChoiceBox.getValue() + "'";
                                ...
                                while (RadiologistsID.next()) {
                                    ...
                                    String InsertIntoUsersTableQuery = "insert into diagnostic_reports (order_id,  radiologist, diagnostic) values ('"
                                            + OrdersChoiceBox.getValue() + "', '" + RadiologistID + "', '"
            ...
            public void handle(ActionEvent event) {
                ...
                SaveUserButton.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent e) {
                        ...
                        if (UsernameField.getText().isEmpty() || displayNameField.getText().isEmpty()
                                || EmailAddressField.getText().isEmpty() || PasswordField.getText().isEmpty()
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        CreateNewModalityButton.setOnAction(new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent e) {
                                ...
                                if (ModalityNameTextField.getText().isEmpty()
                                        || ModalityPriceTextField.getText().isEmpty()) {
                                }
                                    ...
                                    try {
                                        ...
                                        String InstertIntoModalitiesTable = "update modalities set name = '"
                                                + ModalityNameTextField.getText().trim() + "', price = '"
                                                + ModalityPriceTextField.getText().trim() + "' where modality_id = '"
                                                + modalityidquery + "';";
        ...
        try {
                        ...
                        CreateNewModalityButton.setOnAction(new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent e) {
                                ...
                                if (PatientAlertNameField.getText().isEmpty()) {
                                    ...
                                    try {
                                        String InsertIntoAlerts = "update alerts set alert_name = '"
                                                + PatientAlertNameField.getText().trim() + "' where alert_id = '"
                                                + alertidquery + "';";
                                        Statement statement = connectDB.createStatement();
                                        statement.execute(InsertIntoAlerts);
            ...
            SortedList<TABLEPatientAlertsTableController> PatientsAlertsSortedData = new SortedList<>(
                    PatientsAlertsFilteredData);
                            ...
                            public void handle(ActionEvent e) {
                                ...
                                if (firstNameField.getText().isEmpty() || lastNamefield.getText().isEmpty()
                                    ...
                                    try {
                                        ...
                                        String PlacedOrdersTableQuery = "update patients set first_name = '"
                                                + firstNameField.getText().trim() + "', last_name = '"
                                                + lastNamefield.getText().trim() + "', dob = '" + dateofbirth.getValue()
                                                + "', sex = '" + sexChange.getValue() + "', race = '"
                                                + RaceChange.getValue() + "', ethnicity = '"
                                                + EthnicityChange.getValue() + "' where patient_id = '" + patient_id
                                                + "';";
        ...
        try {
            ...
            while (queryOutput.next()) {
                ...
                FileUploadsObservableList.add(
                        ...
                        new TABLEFileUploadsTableController(uploadidquery, filenamequery, filetypequery,
                                ordernumberquery, isopenquery, button));
            }
        ...
        try {
            ...
            while (queryOutput.next()) {
                        ...
                        CreateOrderButton.setOnAction(new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent e) {
                                ...
                                try {
                                    ...
                                    String[] firstandlastnames = SelectedPatientField.getValue().toString().split(" ",
                                            2);
                                    String GetReferralID = "select id from referralmds where full_name = '"
                                            + SelectedDoctorField.getValue() + "';";
                                    String GetModalityID = "select modality_id from modalities where name = '"
                                            + ModalityChoiceBox.getValue() + "';";
                                    String GetStatusID = "select order_status_id from order_status where order_name = '"
                                            + SelectedStatusField.getValue() + "';";
                                    ...
                                    while (PatientIDOutput.next() && ReferralIDOutput.next() && ModalityIDOutput.next()
                                            && StatusIDOutput.next()) {
                                        ...
                                        String UpdateOrdersQuery = "update orders set patient = '" + patient_id
                                                + "', referral_md = '" + referral_id + "', modality = '" + modality_id
                                                + "', notes = '" + ReferralTextField.getText().trim() + "', status = '"
                                                + status_id + "' where order_id = '" + order_id + "';";
                ...
                OrdersTableObservableList.add(
                        ...
                        new TABLEOrdersTableController(order_id, fullname, referral_mdquery, modalityquery, notesquery,
                                statusquery, button));
            }
        ...
        try {
            ...
            while (queryOutput.next()) {
                        ...
                        SaveUserButton.setOnAction(new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent e) {
                                ...
                                if (phoneNumberField.getText().isEmpty() || emailAddressField.getText().isEmpty()
                                        ...
                                        || OrdersChoiceBox.getValue().isEmpty()
                                        || RadiologistChoiceBox.getValue().isEmpty()) {
                                }
                                    ...
                                    try {
                                        ...
                                        String GetRadiologistIDQuery = "select id from radiologists where full_name = '"
                                                + RadiologistChoiceBox.getValue() + "';";
                                        String GetOrderInfoQuery = "select patient, modality from orders where order_id = '"
                                                + OrdersChoiceBox.getValue() + "';";
                                        ...
                                        while (GetRadiologistID.next() && GetOrderInfo.next()) {
                                            ...
                                            String UpdateAppointmentsQuery = "update appointments set phone_number = '"
                                                    + phoneNumberField.getText().trim() + "', email_address = '"
                                                    + emailAddressField.getText().trim() + "', date_time = '"
                                                    + AppointmentDatePicker.getValue() + " "
                                                    + SelectedAppointmentTime.getValue() + "', order_id = '"
                                                    + OrdersChoiceBox.getValue() + "', radiologist = '" + radiologistID
                                                    + "', patient = '" + patientID + "', modality = '" + modalityID
                                                    + "' where appointment_id = '" + appointmentIdquery + "';";
                                            String UpdateOrdersQuery = "update orders set appointment = '"
                                                    + appointmentIdquery + "' where order_id = '"
                                                    + OrdersChoiceBox.getValue() + "';";
                ...
                AppointmentsTableObservableList.add(
                        ...
                        new TABLEAppointmentsTableController(appointmentIdquery, patientquery, ordernumberquery,
                                datetimequery, radiologistquery, button));
            }
        ...
        try {
                            ...
                            public void handle(ActionEvent e) {
                                ...
                                if (UsernameField.getText().isEmpty() || displayNameField.getText().isEmpty()
                                    ...
                                    try {
                                        ...
                                        String InsertIntoUsersTableQuery = "update users set username = '"
                                                + UsernameField.getText().trim() + "', full_name = '"
                                                + displayNameField.getText().trim() + "', email = '"
                                                + EmailAddressField.getText().trim() + "', password = '" + passEncryptt
                                                + "' where user_id = '" + userIDquery + "';";
                                        String UpdateRadiologistTableQuery = "update radiologists set full_name = '"
                                                + displayNameField.getText().trim() + "' where user_id = '"
                                                + userIDquery + "';";
                                        String UpdateRefferalmdTableQuery = "update referralmds  set full_name = '"
                                                + displayNameField.getText().trim() + "' where user_id = '"
                                                + userIDquery + "';";
            ...
            searchSystemUsers.textProperty().addListener((observable, oldValue, newValue) -> {
                SystemUsersFilteredData.setPredicate(TABLESystemUsersTableController -> {
                    ...
                    } else if (TABLESystemUsersTableController.getDisplayname().toLowerCase()
                            .indexOf(searchKeyword) > -1) {
                        return true;
            ...
            SortedList<TABLESystemUsersTableController> SystemUsersSortedData = new SortedList<>(
                    SystemUsersFilteredData);
        ...
        try {
            ...
            while (queryOutput.next()) {
                                ...
                                if (RadiologistChoiceBox.getValue().isEmpty() || OrdersChoiceBox.getValue().isEmpty()
                                    ...
                                    try {
                                        ...
                                        while (RadiologistsID.next()) {
                                            ...
                                            String InsertIntoUsersTableQuery = "update diagnostic_reports set order_id = '"
                                                    + OrdersChoiceBox.getValue() + "', radiologist = '" + RadiologistID
                                                    + "', diagnostic = '" + ReportArea.getText().trim()
                                                    + "' where diagnostic_report_id = '" + reportidquery + "';";
                                            Statement statement = connectDB.createStatement();
                                            statement.execute(InsertIntoUsersTableQuery);
                                            Stage stage = (Stage) CreateDiagnosticReportButton.getScene().getWindow();
                ...
                DiagnosticReportsObservableList.add(
                        ...
                        new TABLEDiagnosticReportsTableController(reportidquery, radiologistquery, ordernumberquery,
                                reportquery, button));
            }
            ...
            searchDiagnosticReports.textProperty().addListener((observable, oldValue, newValue) -> {
                DiagnosticReportsFilteredData.setPredicate(TABLEDiagnosticReportsTableController -> {
                    ...
                    if (TABLEDiagnosticReportsTableController.getRadiologist().toLowerCase()
                            .indexOf(searchKeyword) > -1) {
                        return true;
